...
import TestPage1 from './views/pages/eridirect/ActiveLeads'
import NewLead from './views/pages/eridirect/NewLead'
import ActiveLeadsPage from './views/pages/eridirect/ActiveLeads'
import ActiveLeadsHOC from './components/ActiveLeadsHOC'
import ResultedLeadsPage from './views/pages/eridirect/ResultedLeads'
...
const routes = [
  ...
  // Wrap ActiveLeads with LeadDataProvider
  {
    path: '/ActiveLeads',
    name: 'ActiveLeads',
    element: ActiveLeadsHOC,
  },
  //{ path: '/ActiveLeads', name: 'ActiveLeads', element: ActiveLeadsPage },
  { path: '/ResultedLeads', name: 'ResultedLeads', element: ResultedLeadsPage },
  { path: '/NewLead', name: 'NewLead', element: NewLead },
